...
module.exports = {
  ...
  destroy (req, res) {
    ...
    this.api.services.FootprintService.destroy(req.params.model, criteria, {})
      .then(function (elements) {
        res.status(201).json(elements)
      }).catch(function (error) {
      res.status(500).json(error)
  ...
  createAssociation (req, res) {
    this.api.services.FootprintService.createAssociation(req.params.parentModel, req.params.parentId, req.params.childModel, req.body, {})
      .then(function (elements) {
        res.status(201).json(elements)
      }).catch(function (error) {
      res.status(500).json(error)
  ...
  findAssociation (req, res) {
    this.api.services.FootprintService.findAssociation(req.params.parentModel, req.params.parentId, req.params.childModel, req.params, {})
      .then(function (elements) {
        res.status(201).json(elements)
      }).catch(function (error) {
      res.status(500).json(error)
  ...
  updateAssociation (req, res) {
    this.api.services.FootprintService.updateAssociation(req.params.parentModel, req.params.parentId, req.params.childModel, req.params, req.body, {})
      .then(function (elements) {
        res.status(201).json(elements)
      }).catch(function (error) {
      res.status(500).json(error)
  ...
  destroyAssociation (req, res) {
    this.api.services.FootprintService.destroyAssociation(req.params.parentModel, req.params.parentId, req.params.childModel, req.params.childId, {})
      .then(function (elements) {
        res.status(201).json(elements)
      }).catch(function (error) {
      res.status(500).json(error)
